...
package com.ricoh.service.service.persistence.impl;
...
import com.ricoh.service.exception.NoSuchRegistroException;
import com.ricoh.service.model.Registro;
import com.ricoh.service.model.RegistroTable;
import com.ricoh.service.model.impl.RegistroImpl;
import com.ricoh.service.model.impl.RegistroModelImpl;
import com.ricoh.service.service.persistence.RegistroPersistence;
import com.ricoh.service.service.persistence.impl.constants.lportalPersistenceConstants;
...
public class RegistroPersistenceImpl
	...
	public void activate(BundleContext bundleContext) {
		...
		_argumentsResolverServiceRegistration = _bundleContext.registerService(
			ArgumentsResolver.class, new RegistroModelArgumentsResolver(),
	...
	@Override
	@Reference(
		target = lportalPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = lportalPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	private static class RegistroModelArgumentsResolver
		...
		public Object[] getArguments(
			...
			RegistroModelImpl registroModelImpl = (RegistroModelImpl)baseModel;

			long columnBitmask = registroModelImpl.getColumnBitmask();

			if (!checkColumn || (columnBitmask == 0)) {
				return _getValue(registroModelImpl, columnNames, original);
			}
			...
			if (finderPathColumnBitmask == null) {
				...
				for (String columnName : columnNames) {
					finderPathColumnBitmask |=
						registroModelImpl.getColumnBitmask(columnName);
				}
		...
		public String getClassName() {
			return RegistroImpl.class.getName();
		}

		@Override
		public String getTableName() {
			return RegistroTable.INSTANCE.getTableName();
		}

		private static Object[] _getValue(
			RegistroModelImpl registroModelImpl, String[] columnNames,
			boolean original) {
			...
			for (int i = 0; i < arguments.length; i++) {
				...
				if (original) {
					arguments[i] = registroModelImpl.getColumnOriginalValue(
						columnName);
				}
				else {
					arguments[i] = registroModelImpl.getColumnValue(columnName);
				}
			}
